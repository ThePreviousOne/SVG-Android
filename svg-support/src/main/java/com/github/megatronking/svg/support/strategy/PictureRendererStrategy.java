...
package com.github.megatronking.svg.support.strategy;
...
import com.github.megatronking.svg.support.CachedRendererStrategy;
...
public class PictureRendererStrategy extends CachedRendererStrategy {
    ...
    private Paint getPaint(ColorFilter filter) {
        ...
        mPaint.setAlpha((int) (mRenderer.getmAlpha() * 0xFF));
